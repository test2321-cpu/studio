                ...
                <h5 className="font-semibold mt-4">Last 5 Matches</h5>
                 { (h2hFields as any).map((h2hMatch: any, index: number) => (
                     <div key={index} className="p-2 border rounded-md space-y-2">
                        <FormField control={form.control} name={`headToHead.last5.${index}.teams.0.name`} render={({ field }) => ( <FormItem> <FormLabel>Team 1 Name</FormLabel> <FormControl><Input placeholder="Team Name" {...field} /></FormControl> <FormMessage /> </FormItem> )}/>
                        <FormField control={form.control} name={`headToHead.last5.${index}.teams.0.flag`} render={({ field }) => ( <FormItem> <FormLabel>Team 1 Flag</FormLabel> <FormControl><Input placeholder="flag" {...field} /></FormControl> <FormMessage /> </FormItem> )}/>
                        ...
                        <FormField control={form.control} name={`headToHead.last5.${index}.teams.1.name`} render={({ field }) => ( <FormItem> <FormLabel>Team 2 Name</FormLabel> <FormControl><Input placeholder="Team Name" {...field} /></FormControl> <FormMessage /> </FormItem> )}/>
                        <FormField control={form.control} name={`headToHead.last5.${index}.teams.1.flag`} render={({ field }) => ( <FormItem> <FormLabel>Team 2 Flag</FormLabel> <FormControl><Input placeholder="flag" {...field} /></FormControl> <FormMessage /> </FormItem> )}/>
